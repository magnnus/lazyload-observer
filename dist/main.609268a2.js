(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["AutoTsFE"] = factory();
	else
		root["AutoTsFE"] = factory();
})(window, function() {
...
function () {
  function LazyLoad(el, config) {
    ...
    this._processImageElement = function (target) {
      var _a = _this.config,
          attr = _a.attr,
          srcsetAttr = _a.srcsetAttr,
          removeAttr = _a.removeAttr,
          onLoad = _a.onLoad,
          onError = _a.onError;
    ...
    this.config = __assign({}, LazyLoad.defaultConfig, config); // 获取监听对象
  ...
  LazyLoad.prototype.createObserver = function () {
    ...
    var _a = this.config,
        _b = _a.root,
        root = _b === void 0 ? null : _b,
        _c = _a.rootMargin,
        rootMargin = _c === void 0 ? '0' : _c,
        _d = _a.threshold,
        threshold = _d === void 0 ? 0 : _d,
